import { getButtons, getRemotes } from "@/lib/data";
...
export default async function RemotePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!remote) return <div className="p-10 text-center text-gray-500 font-medium">Remote not found.</div>;
      ...
      <div className="max-w-4xl mx-auto border border-gray-100 overflow-hidden">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-white border border-gray-100 rounded-xl py-4 px-6 flex items-center gap-6 shadow-[0_4px_20px_rgba(0,0,0,0.02)] max-w-2xl">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900 leading-tight">{remote.name}</h2>
          ...
          <section className="space-y-4">
            <div className="flex justify-between items-end px-2">
              <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Buttons</h3>
              <p className="text-[10px] font-mono text-gray-300 italic">tap to send IR signal</p>
            </div>
